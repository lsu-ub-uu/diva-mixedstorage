...
public class XMLXPathParserFactorySpy implements XMLXPathParserFactory {
	...
	public XMLXPathParserSpy factoredPathParser;

	@Override
	public XMLXPathParser factor() {
		factoredPathParser = new XMLXPathParserSpy();
		factoredPathParser.throwException = throwException;
		return factoredPathParser;
	}
